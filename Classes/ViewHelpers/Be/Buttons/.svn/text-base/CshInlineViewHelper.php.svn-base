 ...
 *
 */
class Tx_SfOauth_ViewHelpers_Be_Buttons_CshInlineViewHelper extends Tx_Fluid_ViewHelpers_Be_AbstractBackendViewHelper {
	/**
	 * Render context sensitive help (CSH) for the given table
	 *
	 * @param	string	$table	Table name ('_MOD_'+module name). If not set,
	 * the current module name will be used
	 * @param	string	$field	Field name (CSH locallang main key)
	 * @param	boolean	$iconOnly	If set, the full text will never be shown
	 * (only icon)
	 * @param	string	$styleAttributes	Additional style-attribute content
